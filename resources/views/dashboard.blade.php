<x-app-layout>
    ...
    <main class="mt-6">
        ...
        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
            <a id="docs-card"
                class="flex flex-col items-start gap-6 overflow-hidden rounded-lg
                bg-white text-gray-200 p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] 
                ...
                lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 
